    ...
    <Layout staticHeader>
      ...
      <Section page="contact" color="muted" heading="Let's connect">
        <SplitSection color="muted">
          <div className="left">
            <h3 className="font-body" style={{ fontWeight: "normal" }}>Submit your contact info and a licensed insurance agent will be in touch soon!</h3>
            <form>
